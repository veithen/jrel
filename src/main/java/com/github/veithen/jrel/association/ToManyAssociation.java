...
public abstract class ToManyAssociation<
                T1,
                T2,
                R2 extends ReferenceHolder<T1>,
                C extends Association<T2, T1, R2, MutableReferences<T2>, ?>>
        extends Association<T1, T2, MutableReferences<T2>, R2, C> {
    ...
    @Override
    protected final MutableReferences<T2> doCreateReferenceHolder() {

...
public final class OneToOneAssociation<T1, T2>
        extends ToOneAssociation<T1, T2, MutableReference<T1>, OneToOneAssociation<T2, T1>> {
    private OneToOneAssociation(
            Class<T1> type1, Class<T2> type2, OneToOneAssociation<T2, T1> converse) {

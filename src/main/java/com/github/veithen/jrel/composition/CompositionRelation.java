...
public final class CompositionRelation<T1, T2, T3>
        extends AbstractBinaryRelation<
                T1, T3, References<T3>, References<T1>, CompositionRelation<T3, T2, T1>> {
    private final BinaryRelation<T1, T2> relation1;
    private final BinaryRelation<T2, T3> relation2;

    private CompositionRelation(
            BinaryRelation<T1, T2> relation1,
            BinaryRelation<T2, T3> relation2,
            CompositionRelation<T3, T2, T1> converse) {

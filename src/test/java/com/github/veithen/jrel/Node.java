...
public class Node {
    public static final ManyToOneAssociation<Node, Node> PARENT =
            new ManyToOneAssociation<>(Node.class, Node.class, Navigability.BIDIRECTIONAL);
    public static final TransitiveClosure<Node> DESCENDANTS =
            new TransitiveClosure<>(PARENT.getConverse(), false);

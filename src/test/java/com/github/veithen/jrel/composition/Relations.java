...
public class Relations {
    public static final ManyToManyAssociation<A, B> AB =
            new ManyToManyAssociation<>(A.class, B.class, Navigability.UNIDIRECTIONAL);
    public static final ManyToManyAssociation<B, C> BC =
            new ManyToManyAssociation<>(B.class, C.class, Navigability.UNIDIRECTIONAL);

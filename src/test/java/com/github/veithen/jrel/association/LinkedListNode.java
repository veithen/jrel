...
public class LinkedListNode {
    private static final OneToOneAssociation<LinkedListNode,LinkedListNode> PREVIOUS = new OneToOneAssociation<>(LinkedListNode.class, LinkedListNode.class, true);

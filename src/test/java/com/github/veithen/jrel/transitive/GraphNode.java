...
public class GraphNode {
    public static final ManyToManyAssociation<GraphNode, GraphNode> PARENT =
            new ManyToManyAssociation<>(
                    GraphNode.class, GraphNode.class, Navigability.BIDIRECTIONAL);
    public static final TransitiveClosure<GraphNode> ANCESTOR =
            new TransitiveClosure<>(PARENT, false);
    public static final TransitiveClosure<GraphNode> ANCESTOR_OR_SELF =
    ...
    public final MutableReferences<GraphNode> children =
            PARENT.getConverse().newReferenceHolder(this);
    public final References<GraphNode> descendants =
            ANCESTOR.getConverse().newReferenceHolder(this);
    public final References<GraphNode> descendantsOrSelf =
